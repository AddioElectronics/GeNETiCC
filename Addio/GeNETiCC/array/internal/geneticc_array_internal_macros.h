...
#include "geneticc_array_internal_functions.h"
//#include "../config/geneticc_array_config.h"
...
*	unsafe macros
*
*	Note :	If you use any of these functions more than once on the same array, its recommended that you use "geneticc_list.h" instead.
