/*
	...
	*Uses more memory than a standard array, but will drastically increase performance if you are using the "unsafe" functions, over the "array_geneticc.h" functions.
*/



#ifndef LIST_GENETICC_H_
#define LIST_GENETICC_H_
